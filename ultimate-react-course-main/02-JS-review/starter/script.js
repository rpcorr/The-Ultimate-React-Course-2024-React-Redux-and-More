...
// destructuring an array - relies on the order of the elements in the array.
...
// Create an array of books with more than 500 pages
const longBooks = books.filter((book) => book.pages > 500);
longBooks;

// Create an array of books with more than 500 pages and has a movie adaptation
// Create an array of books with more than 500 pages
...
const arr = [3, 7, 1, 9, 6];
const sorted = arr.slice().sort((a, b) => a - b); // acending
//const sorted = arr.sort((a, b) => b - a); // decending
sorted;
arr;
